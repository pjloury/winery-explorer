...
const WINERIES = [
  ...
  // ───────────────────────── NAPA VALLEY ─────────────────────────
  {
    ...
    hours: {mon:"by appointment", tue:"closed", wed:"closed", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Grounds/Bistro open daily 10:30am-5pm; tastings offered Thursday-Monday by reservation (hours change seasonally)",
    dogFriendly: "outdoor-only", dogNote: "Dogs allowed in The Bistro's outdoor Parisian courtyard; not permitted in interior tasting rooms or caves",
    kidFriendly: "limited", kidNote: "Guests must be at least 12 years old; call ahead to discuss options for younger children",
    reservationRequired: "required", reservationNote: "Reservations required for tastings/experiences; call for same-day (within 24 hours) requests",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Property generally open daily 10:30am-5pm (winter sometimes Wed-Sun); all tastings now by appointment only",
    dogFriendly: "outdoor-only", dogNote: "Leashed dogs welcome at the outdoor private cabana experience",
    kidFriendly: "limited", kidNote: "$10 fee per child over age 2 (includes non-alcoholic beverage) at most tastings; Tour & Tasting and Caviar & Wine Pairing experiences are 21+ only",
    reservationRequired: "required", reservationNote: "All tastings by appointment only, prepaid with 24-48 hour cancellation policy depending on experience",
...

  {
    ...
    dogFriendly: "yes", dogNote: "Leashed dogs welcome on the grounds; 'Discover Beringer' self-guided walkabout experience is designed for both dogs and kids",
    kidFriendly: "yes", kidNote: "Family-friendly; 'Discover Beringer' experience is free for infants/children under 11, $10 for ages 12-20; property is stroller-friendly",
    reservationRequired: "recommended", reservationNote: "Walk-ins possible for some standard tastings; reservations recommended especially for tours (Taste of Beringer, Legacy Cave Tour)",
...

  {
    ...
    dogFriendly: "no", dogNote: "Only ADA service animals permitted (leashed); at the Estate service dogs are outside-only, at Arch & Tower inside and outside",
    kidFriendly: "limited", kidNote: "Main tastings are 21+ focused; separate Discovery Tour welcomes kids (free under 13) on select days",
    reservationRequired: "recommended", reservationNote: "Reservations recommended and book up quickly, but day-of bookings and walk-ins accommodated based on availability",
...

  {
    ...
    hours: {mon:"10:00-15:30", tue:"10:00-15:30", wed:"10:00-15:30", thu:"10:00-15:30", fri:"10:00-15:30", sat:"10:00-15:30", sun:"10:00-15:30"}, hoursNote: "Closed New Year's Day, Jan 5-9, Easter Sunday, Apr 20-24, Thanksgiving, Christmas Eve and Christmas Day",
    dogFriendly: "no", dogNote: "Pets are not permitted anywhere on the estate; only legitimate ADA service animals allowed",
    kidFriendly: "no", kidNote: "Unable to accommodate anyone under 21, including infants and children, anywhere on the grounds",
    reservationRequired: "required", reservationNote: "Strictly appointment-only; reservations open up to two months in advance on the 1st of each month; charges non-refundable within 48 hours",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"},
    dogFriendly: "no", dogNote: "Only certified service animals permitted; cannot accommodate pets",
    kidFriendly: "no", kidNote: "21+ only; infants and children are not permitted at the winery",
    reservationRequired: "required", reservationNote: "Reservations required; contact concierge team by email or phone to book",
...

  {
    ...
    hours: {mon:"09:30-16:00", tue:"09:30-16:00", wed:"09:30-16:00", thu:"09:30-16:00", fri:"09:30-16:00", sat:"09:30-16:00", sun:"09:30-16:00"}, hoursNote: "Hours may vary on select dates/holidays",
    dogFriendly: "no", dogNote: "Property does not welcome pets/animals except service dogs",
    kidFriendly: "no", kidNote: "Unable to accommodate anyone under 21 inside the chateau or as part of any tasting experience",
    reservationRequired: "recommended", reservationNote: "Reservations required for most tastings/tours, though limited walk-in tastings may be available first-come, first-served on select dates",
...

  {
    ...
    hours: {mon:"09:30-14:30", tue:"09:30-14:30", wed:"09:30-14:30", thu:"09:30-14:30", fri:"09:30-14:30", sat:"09:30-14:30", sun:"09:30-14:30"}, hoursNote: "Times reflect tour start window (first tour 9:30am, last tour 2:30pm); each tour/tasting runs about 1h15m",
    dogFriendly: "no", dogNote: "Unable to accommodate pets; only service animals permitted",
    kidFriendly: "no", kidNote: "All visitors must be 21+; unable to accommodate babies or children",
    reservationRequired: "required", reservationNote: "By appointment only; credit card required at booking, 24-hour cancellation policy",
...

  {
    ...
    hours: {mon:"09:30-16:30", tue:"09:30-16:30", wed:"09:30-16:30", thu:"09:30-16:30", fri:"09:30-16:30", sat:"09:30-16:30", sun:"09:30-16:30"},
    dogFriendly: "no", dogNote: "All animals prohibited except ADA service dogs",
    kidFriendly: "limited", kidNote: "21+ tasting establishment, but infants are allowed on property if included in the reservation headcount",
    reservationRequired: "required", reservationNote: "Seated tastings by appointment; groups of 13+ must email tasting room to schedule",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"},
    dogFriendly: "no", dogNote: "Unable to accommodate pets on the property",
    kidFriendly: "no", kidNote: "Unable to accommodate children or guests under 21",
    reservationRequired: "required", reservationNote: "By appointment only; recommended to book at least two weeks in advance",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"11:00-16:00", wed:"11:00-16:00", thu:"11:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Duckhorn's St. Helena estate is closed for renovation (~April 2026 to spring 2027). Hours shown are for the temporary tasting location, The Duckhorn Collection at Paraduxx (7257 Silverado Trail, Napa); all visits by reservation.",
    dogFriendly: "outdoor-only", dogNote: "Well-behaved leashed dogs welcome in the outdoor courtyard at the Paraduxx location; not permitted during 21+ reserved wine/food experiences or special events.",
    kidFriendly: "limited", kidNote: "Standard tastings are 21+, but family-friendly experiences are offered at set times (10:30am/12:30pm) by appointment, and there's a kid-friendly grassy area.",
    reservationRequired: "required", reservationNote: "Tastings at the temporary Paraduxx location are by prior appointment only (Tock, phone, or email).",
...

  {
    ...
    hours: {mon:"10:00-15:30", tue:"10:00-15:30", wed:"10:00-15:30", thu:"10:00-15:30", fri:"10:00-15:30", sat:"10:00-15:30", sun:"10:00-15:30"},
    dogFriendly: "no", dogNote: "Only certified service animals permitted; regular pets are not allowed.",
    kidFriendly: "no", kidNote: "Guests under 21 are not permitted on the premises.",
    reservationRequired: "recommended", reservationNote: "Reservations required for most experiences (including all Home Ranch estate visits); walk-ins may be accommodated at The Salon in St. Helena as space allows.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"},
    dogFriendly: "no", dogNote: "Official policy states pets are not permitted on property (service/certified animals only); some third-party sources mention dog-friendly outdoor areas, so confirming ahead is wise.",
    kidFriendly: "limited", kidNote: "Kids welcome on the self-guided Sterling Stroll / Tour & Terrace experience (gondola ride, kid snacks/backpacks provided); the seated Hilltop tasting experiences are 21+ only.",
    reservationRequired: "recommended", reservationNote: "Walk-ins are generally accepted (retail tasting available without reservation until 5pm), but booking ahead online is strongly recommended, especially for food-pairing experiences and weekends.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"},
    dogFriendly: "no", dogNote: "Only trained/certified service animals allowed; regular pets are not permitted.",
    kidFriendly: "no", kidNote: "21+ only; infants and children are not permitted at the winery.",
    reservationRequired: "required", reservationNote: "Seated château terrace tastings require advance reservation (online or by phone).",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-16:00", sun:"10:00-16:00"},
    dogFriendly: "no", dogNote: "Only certified service animals permitted; the winery states it \"cannot accommodate pets.\"",
    kidFriendly: "no", kidNote: "21+ only; infants and children are not permitted.",
    reservationRequired: "required", reservationNote: "All guests must have a reservation (booked via Tock); cancellation policy is 72 hours for terrace tastings, 7 days for private experiences.",
...

  {
    ...
    hours: {mon:"10:00-15:30", tue:"closed", wed:"closed", thu:"10:00-15:30", fri:"10:00-15:30", sat:"10:00-15:30", sun:"10:00-15:30"},
    dogFriendly: "no", dogNote: "No official pet-friendly policy is published for guest dogs; assume service animals only, consistent with comparable by-appointment Napa estates. (inferred)",
    kidFriendly: "no", kidNote: "Unable to accommodate guests under age 21 due to the intimate nature of the tasting experience.",
    reservationRequired: "required", reservationNote: "By-appointment only, Thursday-Monday; booked and charged in advance by credit card, 24-hour cancellation policy.",
...

  {
    ...
    hours: {mon:"10:00-17:30", tue:"10:00-17:30", wed:"10:00-17:30", thu:"10:00-17:30", fri:"10:00-17:30", sat:"10:00-17:30", sun:"10:00-17:30"},
    dogFriendly: "outdoor-only", dogNote: "Well-behaved dogs welcome on the outdoor grounds/patio and grassy lawn, but not inside the tasting room or on winery tours (service animals excepted).",
    kidFriendly: "yes", kidNote: "Family-friendly grounds with a large lawn (the Great Lawn) great for kids/strollers and picnicking amid the art collection.",
    reservationRequired: "recommended", reservationNote: "Reservations required for guided tasting experiences and tours (limited to 6 guests); some casual outdoor/lawn access and retail may be available without booking.",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"},
    dogFriendly: "no", dogNote: "Cannot accommodate pets; only certified service animals allowed on the property.",
    kidFriendly: "no", kidNote: "Cannot accommodate anyone under age 21, including infants and children.",
    reservationRequired: "required", reservationNote: "Tasting reservations required via hospitality team; larger parties (8+) coordinate directly with the estate manager.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"11:00-15:00", wed:"11:00-15:00", thu:"11:00-15:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"},
    dogFriendly: "yes", dogNote: "Dog-friendly patio, plus the self-guided \"Wine Tails Trail\" vineyard walk for guests with dogs.",
    kidFriendly: "no", kidNote: "All guests, including non-tasting companions, must be 21 or older.",
    reservationRequired: "required", reservationNote: "All tasting experiences require advance reservation (max 6 guests per experience).",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"by appointment", wed:"by appointment", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"},
    dogFriendly: "no", dogNote: "No official pet policy is published; seated indoor Legacy Tasting Experience suggests dogs are not accommodated, though this is unconfirmed. (inferred)",
    kidFriendly: "limited", kidNote: "No explicit age restriction is published (not marketed as 21+ like several Napa neighbors), but the seated tasting/culinary format has no dedicated kids' amenities. (inferred)",
    reservationRequired: "required", reservationNote: "Reservations required for the seated Legacy Tasting Experience (parties up to 6); Tuesday-Wednesday visits are by appointment only.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Appointment-only wine tasting & food pairing experiences, generally available daily 9:00-17:00 window.",
    dogFriendly: "no", dogNote: "Official experiences page states no animals permitted except trained service dogs.",
    kidFriendly: "no", kidNote: "21+ only; no children or persons under 21 permitted at the estate.",
    reservationRequired: "required", reservationNote: "Tastings are by appointment only; no walk-ins.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"closed", sun:"closed"}, hoursNote: "Strictly by appointment; specific weekday windows not published, weekday-only availability assumed (inferred).",
    dogFriendly: "outdoor-only", dogNote: "Proprietors keep winery dogs on site; no published visitor pet policy, so outdoor/estate grounds only is assumed (inferred).",
    kidFriendly: "limited", kidNote: "No published children's policy for this small, appointment-only estate; treat as adult-oriented (inferred).",
    reservationRequired: "required", reservationNote: "Strictly by appointment only, contact via phone or email to schedule.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Open by prior appointment only, seven days a week, at the Mount Veeder Hospitality Center.",
    dogFriendly: "no", dogNote: "Only certified service animals permitted; no pets.",
    kidFriendly: "no", kidNote: "All visitors must be at least 21 years of age.",
    reservationRequired: "required", reservationNote: "Visits offered on a limited, by-appointment basis only; call or text to book.",
...

  {
    ...
    dogFriendly: "outdoor-only", dogNote: "Leashed dogs welcome on the outdoor patio only; call ahead to let staff know you're bringing a dog.",
    kidFriendly: "yes", kidNote: "Family-run tasting room that lists Families & Children among its offerings; on-site Madeleine's Macarons crepe/pastry stand.",
    reservationRequired: "recommended", reservationNote: "Walk-ins welcome for standard tastings; reservations advised, and required for the Wine & Cheese and NOMAD Library experiences.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Tastings by appointment only, roughly 10:00-16:00 window; email to schedule.",
    dogFriendly: "no", dogNote: "No published pet policy for guests; staff have been seen with a dog on-site but no confirmed visitor policy (inferred as not officially dog-friendly).",
    kidFriendly: "limited", kidNote: "No published children's policy; intimate appointment-only cave tastings suggest an adult-oriented visit (inferred).",
    reservationRequired: "required", reservationNote: "Tastings are exclusively by appointment; no walk-ins.",
...

  {
    ...
    hours: {mon:"09:00-17:00", tue:"09:00-17:00", wed:"09:00-17:00", thu:"09:00-17:00", fri:"09:00-17:00", sat:"closed", sun:"closed"}, hoursNote: "Visits by appointment within Monday-Friday business hours; largely reserved for allocation/club members.",
    dogFriendly: "no", dogNote: "Not listed among Napa dog-friendly wineries and no pet policy published; ultra-private estate (inferred).",
    kidFriendly: "no", kidNote: "21+ only property.",
    reservationRequired: "required", reservationNote: "Private, appointment-only visits (via Tock), largely for allocation customers; the estate rarely opens to the general public.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open daily 10:00 a.m.-5:00 p.m., excluding major holidays.",
    dogFriendly: "yes", dogNote: "Well-behaved, leashed dogs are welcome at the winery.",
    kidFriendly: "limited", kidNote: "No published children's policy; upscale signature/private tasting format suggests limited amenities for kids (inferred).",
    reservationRequired: "recommended", reservationNote: "Reservations strongly encouraged, especially on weekends; site pushes 'Reserve Now' for most experiences.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"closed", wed:"closed", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Closed Tuesday and Wednesday.",
    dogFriendly: "yes", dogNote: "Well-behaved pets welcome outdoors on leash.",
    kidFriendly: "limited", kidNote: "Tasting guests must be 21+, but children may accompany with non-alcoholic beverages like grape juice available on request.",
    reservationRequired: "recommended", reservationNote: "Walk-ins welcome based on availability; advance reservations kindly encouraged.",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Closed Monday and Tuesday.",
    dogFriendly: "no", dogNote: "Unable to accommodate pets due to the nature of the food-paired tasting experiences.",
    kidFriendly: "no", kidNote: "Unable to accommodate persons under 21, including infants.",
    reservationRequired: "required", reservationNote: "Reservations required for all tastings Wednesday-Sunday; book via website, phone, or email.",
...

  {
    ...
    hours: {mon:"09:30-18:00", tue:"09:30-18:00", wed:"09:30-18:00", thu:"09:30-18:00", fri:"09:30-18:00", sat:"09:30-18:00", sun:"09:30-18:00"}, hoursNote: "Open daily.",
    dogFriendly: "outdoor-only", dogNote: "Leashed dogs welcome on the outdoor picnic grounds but not inside the tasting room or deli/marketplace.",
    kidFriendly: "yes", kidNote: "Family-friendly picnic grounds, deli, and marketplace; popular with kids.",
    reservationRequired: "walk-in", reservationNote: "Known as a 'no reservations' winery; walk-ins welcome for general tasting and picnic grounds, though some elevated/private experiences can be reserved.",
  ...
  },
  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"closed", sun:"closed"}, hoursNote: "No public tasting room; private visits/inquiries only. Exact operating days not published (weekday availability inferred).",
    dogFriendly: "yes", dogNote: "Listed as pet-friendly for private visits per tasting-room directory listing; remote Howell Mountain estate setting.",
    kidFriendly: "yes", kidNote: "Children allowed per visitor directory listing (inferred, not on official site).",
    reservationRequired: "required", reservationNote: "No public tastings; visits are by private inquiry/appointment only.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Appointment-only tastings hosted at Wheeler Farms in St. Helena; a limited number of reservations are offered each month, exact available days vary and are confirmed at booking.",
    dogFriendly: "no", dogNote: "(inferred) Not specified on site; formal seated wine/food pairing experience, no pet policy published.",
    kidFriendly: "limited", kidNote: "(inferred) Not specified; $150+ seated pairing experience is adult-oriented, not structured for children.",
    reservationRequired: "required", reservationNote: "Appointment-only via reservation request form, limited monthly availability.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Seated reservation-only tastings offered daily at 10:00am, 12:00pm, and 3:00pm; library tastings additionally Thu-Sat at 10:00am.",
    dogFriendly: "yes", dogNote: "(inferred) Visitor reviews mention dogs present at the estate; official pet policy not published — confirm when booking.",
    kidFriendly: "limited", kidNote: "(inferred) Not specified; small seated hilltop tasting format is best suited for adults.",
    reservationRequired: "required", reservationNote: "Appointment required for scheduled tasting slots; groups of 7+ must contact the winery directly.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Tasting room reopened in the restored 1885 stone winery/hospitality center in 2025; some listings show a temporary closure around early-mid July 2026 (until ~7/12/2026) — confirm current status before visiting.",
    dogFriendly: "yes", dogNote: "Well-behaved leashed dogs reported welcome in outdoor areas; confirm specifics when booking.",
    kidFriendly: "yes", kidNote: "(inferred) No age restriction found; historic estate winery with tours, general public welcome on grounds.",
    reservationRequired: "required", reservationNote: "Reservations now required for all tastings and tours.",
...

  {
    ...
    hours: {mon:"10:00-15:00", tue:"closed", wed:"10:00-15:00", thu:"10:00-15:00", fri:"10:00-15:00", sat:"10:00-15:00", sun:"10:00-15:00"}, hoursNote: "By appointment only within these hours; closed Tuesdays.",
    dogFriendly: "no", dogNote: "Only service animals permitted at the Estate; regular pets are not allowed.",
    kidFriendly: "no", kidNote: "21+ only; children under 21 are not permitted on the property.",
    reservationRequired: "required", reservationNote: "By appointment only via Tock; no walk-ins.",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Hours are for the Royal We Wines collective tasting room (opened July 2025) where Caterwaul is poured, at 929 Main St, St. Helena.",
    dogFriendly: "no", dogNote: "(inferred) No pet policy published; indoor Main Street storefront tasting room — call ahead if bringing a dog.",
    kidFriendly: "no", kidNote: "21-and-over tasting room.",
    reservationRequired: "recommended", reservationNote: "Walk-ins possible at the collective tasting room, but booking ahead via Tock is recommended, especially for Caterwaul-specific pours.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"},
    dogFriendly: "yes", dogNote: "Leashed dogs welcome; guests are encouraged to note dogs in their reservation details.",
    kidFriendly: "yes", kidNote: "Minors welcome and must be included in the reservation headcount; seated tastings limited to parties of 6 or fewer including minors.",
    reservationRequired: "recommended", reservationNote: "Reservations recommended at least one week in advance; select walk-in tasting experiences are also available.",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"},
    dogFriendly: "yes", dogNote: "Leashed dogs welcome in outdoor patio/lawn areas; water bowls provided.",
    kidFriendly: "limited", kidNote: "Tasting room is small and seated tastings are geared to 21+ guests; children generally not accommodated for formal tastings.",
    reservationRequired: "required", reservationNote: "Reservations required for all tastings; very small tasting room limits walk-in capacity.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"closed", wed:"closed", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open Thursday through Monday; closed Tuesday and Wednesday.",
    dogFriendly: "no", dogNote: "Dogs/pets are not permitted on the property.",
    kidFriendly: "no", kidNote: "21-and-over; children are not permitted.",
    reservationRequired: "required", reservationNote: "Reservations required via Tock or phone; call the Faust Haus if a desired time/party size isn't showing online.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"closed", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Closed Tuesdays.",
    dogFriendly: "outdoor-only", dogNote: "Well-behaved dogs welcome at outdoor tables on the patio; indoor tasting room pet policy not specified.",
    kidFriendly: "limited", kidNote: "(inferred) No explicit children's policy published; seated tastings by appointment, best to call ahead if bringing kids.",
    reservationRequired: "recommended", reservationNote: "Seated tastings by appointment recommended (call concierge for same-day); walk-ins accommodated first-come, first-served when space allows.",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"closed", fri:"closed", sat:"closed", sun:"closed"}, hoursNote: "No public tasting room; wines are sold via mailing list, and through select restaurants and shops (inferred).",
    dogFriendly: "no", dogNote: "Not applicable — no public visits offered (inferred).",
    kidFriendly: "no", kidNote: "Not applicable — no public visits offered (inferred).",
    reservationRequired: "required", reservationNote: "No public tastings offered at all; access is via mailing list only, not appointment-based visits (inferred).",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"closed"}, hoursNote: "Private, owner-hosted tastings at a house near Main Street, St. Helena; specific days/hours are not published and are arranged directly by email (inferred typical weekday/Saturday availability).",
    dogFriendly: "no", dogNote: "No published pet policy found; not confirmed dog-friendly (inferred).",
    kidFriendly: "limited", kidNote: "Small, intimate private tasting; no published kids policy, best to inquire when booking (inferred).",
    reservationRequired: "required", reservationNote: "Private tastings by appointment only — email audra@newfoundwines.com to book; no walk-ins.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"closed"}, hoursNote: "Private tastings hosted at Paula Kornell's St. Helena home; no fixed public hours, scheduled directly by phone/email (inferred typical weekday/Saturday availability).",
    dogFriendly: "yes", dogNote: "Hosted at the owner's home ('Chateau Drool'), where guests are greeted by resident dogs; dog-friendly, casual atmosphere (inferred from house-tasting setting).",
    kidFriendly: "limited", kidNote: "Intimate private home tasting focused on sparkling wine; no explicit kids policy published, best to ask when booking (inferred).",
    reservationRequired: "required", reservationNote: "By appointment only — contact via phone (877) 289-9463 or email to schedule; no walk-ins.",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Open daily 10am–4pm; closed New Year's Day, Thanksgiving, Christmas Eve, Christmas Day, and Nov 20.",
    dogFriendly: "outdoor-only", dogNote: "Well-behaved leashed dogs welcome in outdoor garden tasting areas; not permitted in cave or elevated tasting experiences.",
    kidFriendly: "limited", kidNote: "Kids welcome for Garden View seating; guests under 21 cannot join cave tours or elevated tasting experiences.",
    reservationRequired: "required", reservationNote: "Reservations required for nearly all experiences and strongly encouraged as they fill quickly, especially on weekends; book online or via the concierge.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open daily 10am–5pm.",
    dogFriendly: "outdoor-only", dogNote: "Dogs welcome on the Valley Vista Terrace; pet policy can vary by specific experience/seating area, so confirm when booking.",
    kidFriendly: "limited", kidNote: "Children welcome on the Valley Vista Terrace; not permitted on the ATV Vineyard & Cave Lounge Tasting or Cave Tour & Tasting (21+ experiences).",
    reservationRequired: "required", reservationNote: "Reservations required for tasting experiences and events; at least 48 hours' notice requested for changes/cancellations.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open daily 10am–5pm.",
    dogFriendly: "no", dogNote: "Pets are not permitted for the winery's curated wine & food tasting experiences per official site guidance.",
    kidFriendly: "limited", kidNote: "Family-friendly estate with an art gallery and grounds, but no explicit children's policy for tastings published — call ahead (inferred).",
    reservationRequired: "recommended", reservationNote: "Walk-ins welcome Monday–Thursday based on availability; reservations highly recommended Friday–Sunday and required for Wine & Food Experiences.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open daily 10am–5pm, by appointment.",
    dogFriendly: "outdoor-only", dogNote: "Dog-friendly at outside tables/patio areas of the estate.",
    kidFriendly: "limited", kidNote: "No explicit children's policy published for this family estate; recommend calling ahead for young kids (inferred).",
    reservationRequired: "required", reservationNote: "Advance reservations required for all visits; walk-ins are not generally accommodated. Call (707) 963-9646 or email hospitality@sullivanwine.com.",
    tours: "Yes — reservation required.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"closed", sun:"closed"}, hoursNote: "The St. Helena property is a private production facility, not a standard walk-in tasting room; tastings are offered by appointment only, primarily to mailing-list/allocated guests (inferred weekday-only schedule).",
    dogFriendly: "no", dogNote: "No published pet policy found for the private St. Helena facility (inferred, unconfirmed).",
    kidFriendly: "limited", kidNote: "No published children's policy found for the private St. Helena facility (inferred, unconfirmed).",
    reservationRequired: "required", reservationNote: "Appointment only — call (707) 963-0940 to schedule; priority generally given to mailing list members (inferred).",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"closed", fri:"closed", sat:"closed", sun:"closed"}, hoursNote: "No tasting room and not set up for visitors; wines are allocated exclusively through the mailing list/Registry.",
    dogFriendly: "no", dogNote: "Not applicable — no public or private visits offered.",
    kidFriendly: "no", kidNote: "Not applicable — no public or private visits offered.",
    reservationRequired: "required", reservationNote: "No visits offered at all; contact VHR@vinehillranch.com only regarding the mailing list registry (inferred).",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"closed", fri:"closed", sat:"closed", sun:"closed"}, hoursNote: "No public tastings; visits are by appointment only for active mailing-list members (and waiting-list guests), not open to the general public.",
    dogFriendly: "no", dogNote: "Not applicable — visits restricted to allocation members by appointment; no published pet policy (inferred).",
    kidFriendly: "no", kidNote: "Not applicable — visits restricted to allocation members by appointment; no published kids policy (inferred).",
    reservationRequired: "required", reservationNote: "Appointment required and reservation priority is given to active mailing-list members; others must join the waiting list.",
...

  {
    ...
    hours: {mon:"11:00-17:00", tue:"11:00-17:00", wed:"closed", thu:"11:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Hours shown are for the St. Helena estate location (address matches Del Dotto Estate); by reservation only, no walk-ins accepted. A second location (Piazza Del Dotto, Oakville) keeps similar hours.",
    dogFriendly: "no", dogNote: "Only certified service animals permitted; pets and emotional support animals are not allowed on the premises",
    kidFriendly: "no", kidNote: "21+ only property; children and infants are not permitted, valid photo ID required",
    reservationRequired: "required", reservationNote: "By reservation only at all locations; same-day requests must be made by phone (707-963-2134), not online",
  ...
  },
  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"closed"}, hoursNote: "No public tasting room — private guided cave tour & seated tasting only, generally scheduled within a 10am-5pm window Monday-Saturday",
    dogFriendly: "no", dogNote: "No published pet policy; the formal private indoor tour/tasting through the cave and salon suggests dogs are not accommodated (inferred)",
    kidFriendly: "yes", kidNote: "Families are welcome to bring children on the private tour and tasting",
    reservationRequired: "required", reservationNote: "By appointment only, arranged well in advance by phone or email; no walk-ins",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Open daily by appointment; last tasting typically begins around 3:00pm",
    dogFriendly: "outdoor-only", dogNote: "Well-behaved leashed dogs welcome on the outdoor patio, weather permitting",
    kidFriendly: "no", kidNote: "21+ only property",
    reservationRequired: "required", reservationNote: "Appointments required; submit a request via the website or call (707) 224-2211",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"closed", wed:"closed", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Closed Tuesdays and Wednesdays",
    dogFriendly: "yes", dogNote: "Dog-friendly property with leashed dogs welcome; also home to on-site 'Frenchie Winery,' Napa Valley's first dog tasting suite",
    kidFriendly: "limited", kidNote: "Family-friendly experiences offered (e.g. 'Goals in the Grove'), though premium experiences like the Crystal Cellar and Winemaker for a Day are adult-oriented",
    reservationRequired: "recommended", reservationNote: "Reservations recommended for themed experiences (Crystal Cellar, Red Room, Theater of Nature)",
...

  {
    ...
    hours: {mon:"11:00-18:00", tue:"11:00-17:00", wed:"11:00-17:00", thu:"11:00-17:00", fri:"11:00-18:00", sat:"10:00-18:00", sun:"10:00-18:00"},
    dogFriendly: "no", dogNote: "Only ADA service animals allowed inside the tasting bay; no outdoor seating currently offered for pets",
    kidFriendly: "limited", kidNote: "A Family Tasting option welcomes kids under 21, but children count toward group size and are subject to large-group fees",
    reservationRequired: "recommended", reservationNote: "Reservations suggested; operates largely by appointment and walk-ins are accommodated as space allows, held a maximum of 15 minutes past scheduled time",
...

  {
    ...
    hours: {mon:"10:00-16:30", tue:"10:00-16:30", wed:"10:00-16:30", thu:"10:00-16:30", fri:"10:00-16:30", sat:"10:00-16:30", sun:"10:00-16:30"}, hoursNote: "Appointment-only; hours reflect the general daily tasting window",
    dogFriendly: "no", dogNote: "Unable to accommodate pets",
    kidFriendly: "no", kidNote: "21+ only; unable to accommodate children or guests under 21",
    reservationRequired: "required", reservationNote: "Appointment-only; reservations encouraged especially on weekends, though walk-ins may occasionally be accommodated if space allows",
...

  {
    ...
    hours: {mon:"10:00-15:30", tue:"10:00-15:30", wed:"closed", thu:"10:00-15:30", fri:"10:00-15:30", sat:"10:00-15:30", sun:"10:00-15:30"}, hoursNote: "Closed Wednesdays. Guided tours (which include a tasting) run Thursday-Monday at 10:30am and 1:30pm",
    dogFriendly: "outdoor-only", dogNote: "Dogs are not permitted inside the winemaking facilities; the Vineyard House deck and garden tasting areas are more accommodating for leashed dogs",
    kidFriendly: "limited", kidNote: "Most experiences (Rooted in Rutherford, Vineyard House Tour, Garden Tasting) are 21+, but a Family Friendly Garden Tasting option is offered for guests with children",
    reservationRequired: "required", reservationNote: "All tastings are by reservation only; book online or call 707-963-4704",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "St. Helena location closed July 25-28, 2026 for the annual Joy of Wine event",
    dogFriendly: "outdoor-only", dogNote: "Leashed dogs welcome at outside tables on the terrace",
    kidFriendly: "yes", kidNote: "Children are welcome; must be included in the total guest count for the reservation",
    reservationRequired: "required", reservationNote: "Appointment required for all tastings; last pour typically at 4:30pm",
...

  {
    ...
    hours: {mon:"10:00-16:30", tue:"10:00-16:30", wed:"10:00-16:30", thu:"10:00-16:30", fri:"10:00-16:30", sat:"10:00-16:30", sun:"10:00-16:30"}, hoursNote: "Closed major holidays (Thanksgiving, Christmas Eve/Day, Easter, July 4th, New Year's Day)",
    dogFriendly: "outdoor-only", dogNote: "Well-behaved leashed dogs welcome on the picnic grounds only, not in the indoor tasting room",
    kidFriendly: "limited", kidNote: "Children welcome on the picnic grounds only; the indoor tasting room is reserved for guests 21+",
    reservationRequired: "recommended", reservationNote: "Reservations recommended and required for parties over 5-6 guests; walk-ins welcome based on availability",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Open daily by appointment; not open to walk-in visitors",
    dogFriendly: "yes", dogNote: "Pet friendly with advance notice per third-party sources (not confirmed on the official site) (inferred)",
    kidFriendly: "limited", kidNote: "Described as family-friendly by travel guides, but the official site does not publish a specific children's policy for the seated tasting experience (inferred)",
    reservationRequired: "required", reservationNote: "Open daily by appointment only; book by phone (707-302-8181) or email",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "By appointment only; seatings at 10am/12pm/2pm/4pm. Champagne tasting offered Thu-Sat only. Property gate open Mon-Sat 6am-6pm and closed Sundays (call ahead for gate code on Sunday appointments).",
    dogFriendly: "no", dogNote: "No dog policy published; tastings are held in a formal cave setting — assume dogs are not accommodated (inferred).",
    kidFriendly: "limited", kidNote: "No children's policy published for this intimate, high-end cave tasting experience; likely not well-suited to kids (inferred).",
    reservationRequired: "required", reservationNote: "All tastings require advance reservation; the Champagne tasting must be booked at least a week ahead.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "By appointment only, privately hosted; tastings currently book 4-6 weeks in advance.",
    dogFriendly: "yes", dogNote: "Dogs are welcome to join tastings on this small estate.",
    kidFriendly: "limited", kidNote: "Generally described as kid-friendly, but the signature ATV ride to the hilltop viewpoint may not be appropriate for young children; confirm age suitability when booking (partially inferred).",
    reservationRequired: "required", reservationNote: "Private, hosted tastings only — book via email/phone well in advance; last-minute bookings possible by calling/texting.",
  ...
  // ───────────────────────── SONOMA COUNTY ─────────────────────────
  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open daily except major holidays; last seating 4:00pm for standing bar tasting, 3:30pm for seated tastings.",
    dogFriendly: "outdoor-only", dogNote: "Leashed dogs welcome on the grounds/picnic areas; not indicated for indoor tasting rooms.",
    kidFriendly: "yes", kidNote: "Kids welcome in the tasting area with adults; historic Wine Tool Museum, hedge maze, and costumed 'Count' character tours designed for families.",
    reservationRequired: "recommended", reservationNote: "Walk-ins accepted for the standing bar tasting; seated/reserve tastings require advance booking, especially on weekends.",
...

  {
    ...
    hours: {mon:"11:00-17:30", tue:"11:00-17:30", wed:"11:00-17:30", thu:"11:00-17:30", fri:"11:00-17:30", sat:"11:00-17:30", sun:"11:00-17:30"}, hoursNote: "Open daily, last seatings at 4:00pm.",
    dogFriendly: "outdoor-only", dogNote: "Leashed, well-behaved dogs welcome for courtyard tastings; not permitted on tours, events, or concerts.",
    kidFriendly: "limited", kidNote: "Kids of all ages welcome for tastings (may count toward seating headcount); must be at least 12 for tour experiences, with adult supervision required for anyone under 21.",
    reservationRequired: "recommended", reservationNote: "Not mandatory, but strongly recommended especially on weekends; drop-ins accommodated first-come-first-served with a 15-minute grace period on reserved spots.",
...

  {
    ...
    hours: {mon:"10:00-16:30", tue:"10:00-16:30", wed:"10:00-16:30", thu:"10:00-16:30", fri:"10:00-16:30", sat:"10:00-16:30", sun:"10:00-16:30"}, hoursNote: "Open daily; tastings offered 10:00am-3:30pm. Free historic winery tours and seasonal rose-garden tours are first-come, first-served.",
    dogFriendly: "outdoor-only", dogNote: "Leashed dogs welcome on the outdoor decks and in the redwood grove near the deli; service animals welcome throughout.",
    kidFriendly: "limited", kidNote: "Kids are welcome and the free historic tour is family-friendly, but there are no dedicated kids' activities — better suited to older children.",
    reservationRequired: "walk-in", reservationNote: "Tours and tastings are generally first-come, first-served; reservations only needed for private seated tastings of 7 or more guests.",
...

  {
    ...
    hours: {mon:"10:30-17:00", tue:"10:30-17:00", wed:"10:30-17:00", thu:"10:30-17:00", fri:"10:30-17:00", sat:"10:30-17:00", sun:"10:30-17:00"}, hoursNote: "Open daily; last reservation/seating at 3:30pm.",
    dogFriendly: "outdoor-only", dogNote: "Dogs welcome on leash in the historic courtyard picnic area; reviews are mixed on whether dogs are allowed inside the tasting room, so outdoor seating is the safe bet.",
    kidFriendly: "yes", kidNote: "Family-friendly, laid-back tasting room with a spacious courtyard where kids can stretch their legs while parents taste.",
    reservationRequired: "walk-in", reservationNote: "Walk-ins now accepted at the tasting bar; seated tastings can also be reserved in advance.",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"10:00-16:00", wed:"10:00-16:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Open daily.",
    dogFriendly: "yes", dogNote: "Leashed, well-behaved dogs welcome; excessive barking or aggressive behavior is not allowed.",
    kidFriendly: "no", kidNote: "21+ property — children and infants are not permitted at this time.",
    reservationRequired: "recommended", reservationNote: "Reservations strongly encouraged; groups of 8 or fewer can often be accommodated as walk-ins if space allows — call ahead for same-day visits.",
...

  {
    ...
    hours: {mon:"08:00-16:30", tue:"08:00-16:30", wed:"08:00-16:30", thu:"08:00-16:30", fri:"08:00-16:30", sat:"09:00-15:30", sun:"09:00-15:30"}, hoursNote: "By appointment only. Closed Sundays from December through March.",
    dogFriendly: "no", dogNote: "Only certified service animals are permitted on the property.",
    kidFriendly: "no", kidNote: "21+ property — designed as an adults-only wine and food pairing experience.",
    reservationRequired: "required", reservationNote: "Advance reservations are required due to the intimacy of the food and wine pairing experiences; no walk-ins.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open daily; reservations available starting 10:30am, last seating 3:30pm. Closed New Year's Day, Easter, Thanksgiving, and Christmas.",
    dogFriendly: "outdoor-only", dogNote: "Dogs welcome on leash throughout the outdoor gardens/vineyard grounds (staff provide water and treats); indoor tasting salons are not noted as pet-friendly.",
    kidFriendly: "yes", kidNote: "Family-friendly garden tour with chickens, kid-sized picnic table, and games for children.",
    reservationRequired: "required", reservationNote: "Advance booking required for tastings via their online ticketing (Tock); garden access may vary.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open daily.",
    dogFriendly: "yes", dogNote: "Well-behaved dogs welcome on leash throughout the property.",
    kidFriendly: "yes", kidNote: "Family-friendly; kids of all ages welcome with adult supervision — bocce ball, an escape room, and Mediterranean-style picnic gardens.",
    reservationRequired: "recommended", reservationNote: "Reservations encouraged; walk-ins welcome depending on availability.",
...

  {
    ...
    hours: {mon:"10:00-15:00", tue:"10:00-15:00", wed:"10:00-15:00", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Closed major holidays.",
    dogFriendly: "no", dogNote: "Dogs not permitted (only registered service animals, no emotional support animals); a public trail just outside the property is popular for dog walks.",
    kidFriendly: "yes", kidNote: "Children welcome but must be supervised at all times.",
    reservationRequired: "required", reservationNote: "All tastings require advance reservations; book about two weeks ahead for weekend visits. No walk-ins.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"closed", sun:"closed"}, hoursNote: "Appointment visits Monday-Friday only; closed August and September for harvest.",
    dogFriendly: "no", dogNote: "Not addressed by the winery; given the intimate 21+ seated estate tours, pets are assumed not accommodated (inferred).",
    kidFriendly: "no", kidNote: "Visitors must be 21 years or older; no children permitted.",
    reservationRequired: "required", reservationNote: "Appointment only, booked online or by phone; no walk-ins.",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"closed", fri:"closed", sat:"closed", sun:"closed"}, hoursNote: "Tasting room permanently closed to the public since February 2023. The winery was acquired by WarRoom Cellars in late 2025, but no reopening of the tasting room has been announced as of mid-2026; production continues onsite.",
    dogFriendly: "no", dogNote: "Not applicable — tasting room closed to all visitors (inferred).",
    kidFriendly: "no", kidNote: "Not applicable — tasting room closed to all visitors (inferred).",
    reservationRequired: "required", reservationNote: "No public visits currently possible under any arrangement; the facility is closed to visitors, not merely appointment-only (inferred).",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"10:30-17:00", fri:"10:30-17:00", sat:"10:30-17:00", sun:"10:30-17:00"}, hoursNote: "Last reservation/seating at 3:00pm.",
    dogFriendly: "outdoor-only", dogNote: "Leashed dogs welcome on the Terrace and Green but not inside the tasting room; not permitted at ticketed events like the Summer Concert Series.",
    kidFriendly: "yes", kidNote: "Children welcome with direct parental supervision requested.",
    reservationRequired: "recommended", reservationNote: "Walk-ins welcome if space is available prior to 3pm, but advance reservations are recommended (credit card holds booking, free cancellation up to 24 hours ahead).",
...

  {
    ...
    hours: {mon:"11:00-17:00", tue:"closed", wed:"closed", thu:"11:00-17:00", fri:"11:00-17:00", sat:"11:00-17:00", sun:"11:00-17:00"}, hoursNote: "Rustic restaurant operates same days, 12pm-7pm; pool is seasonal.",
    dogFriendly: "no", dogNote: "Only service dogs (and dogs-in-training under the same rules) are allowed on the property; general pets are not permitted.",
    kidFriendly: "yes", kidNote: "Very family-friendly, with a resort-style pool, bocce, and a movie memorabilia museum drawing families.",
    reservationRequired: "recommended", reservationNote: "The general tasting bar accepts walk-ins (no reservation needed), but specialty tastings like the Spotlight Series, pool cabanas, and Rustic dining require advance reservations.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Open daily; seated tastings are by appointment.",
    dogFriendly: "no", dogNote: "Dogs are not permitted anywhere on the property (to protect the gardens), per winery policy and multiple visitor reports.",
    kidFriendly: "no", kidNote: "21+ only property; no children or infants permitted at tastings.",
    reservationRequired: "recommended", reservationNote: "Seated tastings by appointment; walk-ins are accommodated based on availability.",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"closed", wed:"closed", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"},
    dogFriendly: "outdoor-only", dogNote: "Leashed dogs welcome on the outdoor patio; only service animals are permitted indoors.",
    kidFriendly: "yes", kidNote: "Guests of all ages welcome; children are included in the total guest count for reservations and should be supervised.",
    reservationRequired: "required", reservationNote: "Seated food-and-wine tastings by advance reservation via Tock; walk-in availability is not offered.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"}, hoursNote: "Closed Thanksgiving, Christmas, and New Year's Day.",
    dogFriendly: "outdoor-only", dogNote: "Dogs welcome in outdoor areas only, must be leashed at all times; service animals permitted throughout.",
    kidFriendly: "limited", kidNote: "Kids welcome but parties are capped at 6 guests total (including children); no dedicated kids' amenities.",
    reservationRequired: "recommended", reservationNote: "Reservations recommended via Tock or phone; walk-ins welcome when space allows.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"closed", sun:"closed"}, hoursNote: "Visits generally offered weekdays 9am-4pm by appointment, primarily to mailing-list members with a purchase history; priority given to active purchasers.",
    dogFriendly: "no", dogNote: "Not specified by the winery; assumed no pets given the exclusive, small-scale appointment-only format (inferred).",
    kidFriendly: "limited", kidNote: "Not specified; likely limited given the intimate, collector-focused appointment-only format (inferred).",
    reservationRequired: "required", reservationNote: "By appointment only, generally limited to mailing-list members with purchase history; not open to general walk-in public.",
...

  {
    ...
    priceRange: [60, 250], tastingFee: "$95–$200, by appointment",
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Seated experiences offered daily at set times (typically 10:00am, 1:00pm, and 3:30pm).",
    dogFriendly: "no", dogNote: "Dogs are not allowed on the property except ADA service dogs.",
    kidFriendly: "yes", kidNote: "Kids are welcome; a non-alcoholic 'dry soda' tasting is offered for children.",
    reservationRequired: "required", reservationNote: "Private, appointment-only estate experiences led by an Estate Ambassador; reserve via phone, email, or Tock.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Appointment-only tastings offered daily, roughly 10:00 AM-4:00 PM; no walk-ins.",
    dogFriendly: "no", dogNote: "Pets are not permitted on the estate.",
    kidFriendly: "limited", kidNote: "Seated wine tastings require guests to be 21+; sources conflict on whether younger visitors may join the sculpture-garden tour (inferred).",
    reservationRequired: "required", reservationNote: "Strictly by appointment; book via Tock or the website.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Appointment tastings available daily, approx. 10:00 AM-5:00 PM, but priority goes to active mailing-list ('The List') members; book at least two weeks ahead.",
    dogFriendly: "no", dogNote: "Only trained service dogs permitted; other pets are prohibited.",
    kidFriendly: "yes", kidNote: "Children of all ages may attend; advance notice appreciated for guests under 21.",
    reservationRequired: "required", reservationNote: "By appointment only for active List members; groups limited to six; 48-hour cancellation notice requested.",
...

  {
    ...
    hours: {mon:"closed", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"closed"}, hoursNote: "All visits by appointment Tuesday-Saturday; closed Sunday and Monday.",
    dogFriendly: "no", dogNote: "No dog policy advertised; not listed as a dog-friendly winery (inferred).",
    kidFriendly: "no", kidNote: "Guests must be 21 or older; non-drinking guests (up to 4 per party) can join the patio tasting but general admission is 21+.",
    reservationRequired: "required", reservationNote: "Appointment-only at the Trenton Roadhouse; allocation-list members get priority booking.",
...

  {
    ...
    hours: {mon:"10:30-16:30", tue:"10:30-16:30", wed:"10:30-16:30", thu:"10:30-16:30", fri:"10:30-16:30", sat:"10:30-16:30", sun:"10:30-16:30"}, hoursNote: "Hours are for the Historic Healdsburg Tasting Room; Bell Mountain Ranch tastings run on a separate reservation schedule.",
    dogFriendly: "yes", dogNote: "Well-behaved dogs are welcomed at the Healdsburg tasting room.",
    kidFriendly: "no", kidNote: "Property policy is 21 and older; children are not permitted at tastings.",
    reservationRequired: "recommended", reservationNote: "Reservations are required for Bell Mountain Ranch and recommended (walk-ins possible) for the Historic Healdsburg Tasting Room.",
...

  {
    ...
    hours: {mon:"10:00-17:00", tue:"10:00-17:00", wed:"10:00-17:00", thu:"10:00-17:00", fri:"10:00-17:00", sat:"10:00-17:00", sun:"10:00-17:00"},
    dogFriendly: "yes", dogNote: "Leashed dogs are welcome on the property, including patio and lawn areas.",
    kidFriendly: "yes", kidNote: "Kids are welcome; property has lawn games/bocce and family-friendly grounds.",
    reservationRequired: "recommended", reservationNote: "Both walk-ins and reservations accepted; groups larger than six should contact the winery directly.",
...

  {
    ...
    hours: {mon:"10:00-16:00", tue:"closed", wed:"closed", thu:"10:00-16:00", fri:"10:00-16:00", sat:"10:00-16:00", sun:"10:00-16:00"}, hoursNote: "Closed Tuesday and Wednesday.",
    dogFriendly: "no", dogNote: "Only licensed service animals are permitted; pets are not allowed.",
    kidFriendly: "no", kidNote: "Property is 21+ only; cannot accommodate guests younger than 21, including infants.",
    reservationRequired: "required", reservationNote: "Reservations required for all seated tasting experiences; prepaid via Tock, modifiable up to 48 hours ahead.",
...

  {
    ...
    hours: {mon:"10:00-15:30", tue:"10:00-15:30", wed:"10:00-15:30", thu:"10:00-15:30", fri:"10:00-15:30", sat:"10:00-15:30", sun:"10:00-15:30"}, hoursNote: "Open 7 days a week with last appointment at 3:30 PM; a special 'Under the Wire' tasting runs Friday-Sunday only.",
    dogFriendly: "no", dogNote: "No dog-friendly policy could be confirmed for the historic Hooker House tasting room (inferred).",
    kidFriendly: "limited", kidNote: "No explicit child policy published; small, intimate indoor tastings with very limited group capacity, especially in winter (inferred).",
    reservationRequired: "required", reservationNote: "Appointments required; call or email ahead, especially for groups larger than four.",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"closed", fri:"by appointment", sat:"closed", sun:"closed"}, hoursNote: "Small-production, mostly mailing-list winery; public tastings offered only on Fridays by appointment.",
    dogFriendly: "yes", dogNote: "Dogs are welcome to walk the grounds along with kids.",
    kidFriendly: "yes", kidNote: "Family-friendly; kids are welcome to walk around the grounds during tastings.",
    reservationRequired: "required", reservationNote: "Appointment-only, Fridays; schedule by phone or email in advance.",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"closed"}, hoursNote: "No public tasting room; appointments available Thursday-Saturday around 10:30 AM, 1:00 PM and 3:00 PM, limited to groups of six or fewer. Over three-quarters of production sells through the mailing list.",
    dogFriendly: "no", dogNote: "No dog policy published for this quiet, family-run estate; not advertised as dog-friendly (inferred).",
    kidFriendly: "limited", kidNote: "No explicit child policy found; small seated appointment tastings with no kid amenities (inferred).",
    reservationRequired: "required", reservationNote: "By appointment only; call or book online, and allocation/mailing-list members get priority access.",
...

  {
    ...
    hours: {mon:"10:30-16:30", tue:"closed", wed:"closed", thu:"10:30-16:30", fri:"10:30-16:30", sat:"10:30-16:30", sun:"10:30-16:30"}, hoursNote: "Open Thursday through Monday; closed Tuesday and Wednesday.",
    dogFriendly: "yes", dogNote: "Dog friendly, particularly in the picnic grounds and garden areas.",
    kidFriendly: "yes", kidNote: "Family-friendly picnic grounds and bocce courts make it a good stop with kids.",
    reservationRequired: "recommended", reservationNote: "Reservations recommended (online closes 24 hours ahead; call for same-day) but walk-ins are welcomed.",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"closed", fri:"closed", sat:"closed", sun:"closed"}, hoursNote: "No public tasting room; this tiny Healdsburg producer releases wines only via mailing list, so there are no visitor hours (inferred).",
    dogFriendly: "no", dogNote: "No public tasting room to visit (inferred).",
    kidFriendly: "no", kidNote: "No public tasting room to visit (inferred).",
    reservationRequired: "required", reservationNote: "Not open to the public; wines are allocated via mailing list only, no tastings offered (inferred).",
...

  {
    ...
    hours: {mon:"by appointment", tue:"closed", wed:"closed", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"},
    dogFriendly: "no", dogNote: "Pets are not permitted at the House of Flowers tasting experiences (service animals only).",
    kidFriendly: "no", kidNote: "21+ property; guests under 21, including infants and small children, are not permitted at any tasting experience.",
    reservationRequired: "required", reservationNote: "Advance reservations are required for all tasting experiences; no walk-ins.",
...

  {
    ...
    hours: {mon:"10:00-16:30", tue:"10:00-16:30", wed:"10:00-16:30", thu:"10:00-16:30", fri:"10:00-16:30", sat:"10:00-16:30", sun:"10:00-16:30"}, hoursNote: "Hours shown are for the Forestville estate tasting room (last appointment 3:30pm); the second tasting room in downtown Healdsburg keeps separate hours.",
    dogFriendly: "yes", dogNote: "Leashed dogs are welcome in the outdoor seating areas at the Forestville estate; mention it when booking.",
    kidFriendly: "yes", kidNote: "Children are welcome.",
    reservationRequired: "recommended", reservationNote: "Seated tastings by appointment, but walk-ins are accommodated if space allows.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Open daily roughly 9:30am-4pm, but all visits are by appointment only.",
    dogFriendly: "no", dogNote: "Dogs are not permitted (service animals excepted); the winery is instead patrolled by resident cats.",
    kidFriendly: "limited", kidNote: "Well-supervised children are permitted but not especially encouraged; tastings are run in an educational, seated format.",
    reservationRequired: "required", reservationNote: "Seated, appointment-only tastings; no walk-ins.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"closed", wed:"closed", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Recently relocated from the longtime Sonoma House to a new bungalow tasting salon near the Sonoma Plaza (opened 2026); last appointment is typically 3:00pm.",
    dogFriendly: "yes", dogNote: "Dog friendly; well-behaved leashed dogs are welcome.",
    kidFriendly: "limited", kidNote: "No explicit age restriction found; seated indoor tasting format with no specific kids' amenities (inferred).",
    reservationRequired: "required", reservationNote: "Reservations required for all tastings; groups larger than 8 or bookings within 24 hours require a phone call.",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"11:00-18:00", thu:"11:00-18:00", fri:"11:00-18:00", sat:"11:00-18:00", sun:"11:00-18:00"}, hoursNote: "Seated tasting flights are generally poured between 11am and 4pm within these retail hours.",
    dogFriendly: "no", dogNote: "No dog policy published; small indoor plaza salon, assumed not particularly dog-oriented (inferred).",
    kidFriendly: "limited", kidNote: "No children's policy published; intimate seated salon tastings with limited capacity, likely light on kid amenities (inferred).",
    reservationRequired: "recommended", reservationNote: "The Serendipity Flight is by appointment or by chance (occasional walk-ins); the Monopole Reserve Tasting is by appointment only.",
...

  {
    ...
    hours: {mon:"by appointment", tue:"by appointment", wed:"by appointment", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"closed"}, hoursNote: "Appointment tastings are typically scheduled at 10:00am or 2:00pm, Monday through Saturday.",
    dogFriendly: "no", dogNote: "Unable to accommodate pets at the tasting room.",
    kidFriendly: "no", kidNote: "Unable to accommodate guests under 21.",
    reservationRequired: "required", reservationNote: "By appointment only; a 90-minute seated flight, with 24-hour cancellation notice required.",
...

  {
    ...
    hours: {mon:"closed", tue:"closed", wed:"closed", thu:"closed", fri:"closed", sat:"closed", sun:"closed"}, hoursNote: "No public tasting room; the historic Gehricke Road tasting room closed to visitors in 2019 after the Constellation Brands (Gallo) acquisition, and the associated winery operations have continued winding down as of 2026.",
    dogFriendly: "no", dogNote: "No public tasting room to visit.",
    kidFriendly: "no", kidNote: "No public tasting room to visit.",
    reservationRequired: "required", reservationNote: "Not open to the public; no tastings offered (inferred).",
...

  {
    ...
    hours: {mon:"by appointment", tue:"closed", wed:"closed", thu:"by appointment", fri:"by appointment", sat:"by appointment", sun:"by appointment"}, hoursNote: "Tasting experiences (Estate and Block Selection) are available Thursday through Monday, by appointment only, at the downtown Healdsburg tasting room.",
    dogFriendly: "no", dogNote: "No pet policy published for the Healdsburg tasting room; assumed not dog-oriented given the small seated indoor format (inferred).",
    kidFriendly: "limited", kidNote: "No children's policy published; 90-minute seated allocation-focused tastings with no stated kids' amenities (inferred).",
    reservationRequired: "required", reservationNote: "Appointment-only; fees charged 48 hours before the reservation, 24-hour cancellation notice required.",
